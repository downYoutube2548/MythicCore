...
public class ElementalShield implements ITargetedEntitySkill {
    ...
    public SkillResult castAtEntity(SkillMetadata skillMetadata, AbstractEntity abstractEntity) {
        ...
        if (BukkitAdapter.adapt(abstractEntity) != null) {
            ...
            MythicCore.getBuffManager().getBuff(bukkittarget.getUniqueId()).addBuff(new com.dev.mythiccore.buff.buffs.ElementalShield(amount.get(skillMetadata), element, duration));
