...
public class ReverseVaporize extends TriggerAuraReaction {
    public ReverseVaporize() {
        super("REVERSE_VAPORIZE", ConfigLoader.getReactionDisplay("REVERSE_VAPORIZE"), ConfigLoader.getAuraElement("REVERSE_VAPORIZE"), ConfigLoader.getTriggerElement("REVERSE_VAPORIZE"), ConfigLoader.getGaugeUnitTax("REVERSE_VAPORIZE"));
    }
