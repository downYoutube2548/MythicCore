...
public class Vaporize extends TriggerAuraReaction {
    public Vaporize() {
        super("VAPORIZE", ConfigLoader.getReactionDisplay("VAPORIZE"), ConfigLoader.getAuraElement("VAPORIZE"), ConfigLoader.getTriggerElement("VAPORIZE"), ConfigLoader.getGaugeUnitTax("VAPORIZE"));
    }
