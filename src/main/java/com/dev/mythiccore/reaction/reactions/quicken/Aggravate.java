...
public class Aggravate extends TriggerAuraReaction {
    public Aggravate(String id, ConfigurationSection config, String display, String aura, String trigger, double gauge_unit_tax) {
